...
@Autonomous(name="Freddy Auto - High Basket 2 Samples", group="Linear OpMode")
public class FreddyAutoHighBasket2Samples extends LinearOpMode {
    ...
    private org.firstinspires.ftc.teamcode.FreddyAutoHighBasket2Samples.armPosition currentArmPosition = org.firstinspires.ftc.teamcode.FreddyAutoHighBasket2Samples.armPosition.home;         //The current arm position

    private org.firstinspires.ftc.teamcode.FreddyAutoHighBasket2Samples.armPosition targetArmPosition = org.firstinspires.ftc.teamcode.FreddyAutoHighBasket2Samples.armPosition.home;          //The target arm position

    private org.firstinspires.ftc.teamcode.FreddyAutoHighBasket2Samples.slidePosition currentSlidePosition = org.firstinspires.ftc.teamcode.FreddyAutoHighBasket2Samples.slidePosition.home;            // The current slide position

    private org.firstinspires.ftc.teamcode.FreddyAutoHighBasket2Samples.slidePosition targetSlidePosition = org.firstinspires.ftc.teamcode.FreddyAutoHighBasket2Samples.slidePosition.home;             // The target slide position

    private org.firstinspires.ftc.teamcode.FreddyAutoHighBasket2Samples.driveMode currentDriveMode = org.firstinspires.ftc.teamcode.FreddyAutoHighBasket2Samples.driveMode.normal;              //The current drive mode
    ...
    private static final FreddyAutoHighBasket2Samples.robot currentRobot = FreddyAutoHighBasket2Samples.robot.Freddy;                   // The robot
    ...
    public void runOpMode() {
        ...
        gyroStrafe(STRAFE_SPEED, 26.0, 0.0, org.firstinspires.ftc.teamcode.FreddyAutoHighBasket2Samples.strafeDirection.left);
        ...
        gyroStrafe(STRAFE_SPEED, 7.0, -45.0, org.firstinspires.ftc.teamcode.FreddyAutoHighBasket2Samples.strafeDirection.left);
    ...
    private void MoveArmToHomePosition() {
        while (opModeIsActive() && this.currentArmPosition != org.firstinspires.ftc.teamcode.FreddyAutoHighBasket2Samples.armPosition.home) {
            ...
            switch (this.currentArmPosition) {
                case collectUp:
                    ...
                    if (this.isMotorAtPosition(slideArmMotor) || this.isArmFrontButtonPressed) {
                        ...
                        //Success
                        this.currentArmPosition = org.firstinspires.ftc.teamcode.FreddyAutoHighBasket2Samples.armPosition.home;
                    }
    ...
    private void MoveArmToDeliveryUpPosition() {
        ...
        while (opModeIsActive() && this.currentArmPosition != org.firstinspires.ftc.teamcode.FreddyAutoHighBasket2Samples.armPosition.deliveryUp) {
            this.HandleArmSensors();
            ...
            switch (this.currentArmPosition) {
                ...
                case collectUp: {
                    ...
                    if (this.isMotorAtPosition(slideArmMotor) || this.isArmBackButtonPressed) {
                        ...
                        //Success
                        this.currentArmPosition = org.firstinspires.ftc.teamcode.FreddyAutoHighBasket2Samples.armPosition.deliveryUp;
                    }
                }
                break;
...
//                }
    ...
    private void MoveSlideToHighBasketPosition() {
        ...
        while (opModeIsActive() && currentSlidePosition != org.firstinspires.ftc.teamcode.FreddyAutoHighBasket2Samples.slidePosition.highBasket) {
            this.HandleArmSensors();
...
//                ((DcMotorEx) this.slideMotor).setVelocity(650);
            ...
            if (this.isMotorAtPosition(slideMotor) ||
                ...
                this.currentSlidePosition = org.firstinspires.ftc.teamcode.FreddyAutoHighBasket2Samples.slidePosition.highBasket;
            }
        }
    }

    private void MoveSlideToHomePosition() {
        while (opModeIsActive() && currentSlidePosition != org.firstinspires.ftc.teamcode.FreddyAutoHighBasket2Samples.slidePosition.home) {
            this.HandleArmSensors();
            ...
            if (this.isMotorAtPosition(slideMotor)) {
                this.currentSlidePosition = org.firstinspires.ftc.teamcode.FreddyAutoHighBasket2Samples.slidePosition.home;
            }
        }
    }
    ...
    private void ConfigureHardwareValues(){
        if (currentRobot == FreddyAutoHighBasket2Samples.robot.Freddy) {
    ...
    public void gyroDrive(double speed, double distance, double angle) {
        ...
        while (opModeIsActive() && !isDriveComplete(targetTicks)) {
            ...
            double[] powers = calculateWheelPowers(speed * direction, 0.0, correction, org.firstinspires.ftc.teamcode.FreddyAutoHighBasket2Samples.strafeDirection.none);
    ...
    public void gyroStrafe(double speed, double distance, double angle, org.firstinspires.ftc.teamcode.FreddyAutoHighBasket2Samples.strafeDirection direction) {
    ...
    public void gyroTurn(double speed, double targetAngle) {
        ...
        do {
            ...
            double[] powers = calculateWheelPowers(0.0, 0.0, turnPower, org.firstinspires.ftc.teamcode.FreddyAutoHighBasket2Samples.strafeDirection.none);
            setMotorPowers(powers);
    ...
    private double[] calculateWheelPowers(double drive, double strafe, double turn, org.firstinspires.ftc.teamcode.FreddyAutoHighBasket2Samples.strafeDirection strafeDirection) {
        double[] wheelPowers = new double[4];

        //Strafe Left
        if (strafeDirection == org.firstinspires.ftc.teamcode.FreddyAutoHighBasket2Samples.strafeDirection.left){
