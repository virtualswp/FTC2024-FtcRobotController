...
import org.firstinspires.ftc.robotcore.external.navigation.YawPitchRollAngles;
    ...
    public class FreddyAutoHighBasketPark extends LinearOpMode {
        ...
        private org.firstinspires.ftc.teamcode.FreddyAutoHighBasketPark.armPosition currentArmPosition = org.firstinspires.ftc.teamcode.FreddyAutoHighBasketPark.armPosition.home;         //The current arm position

        private org.firstinspires.ftc.teamcode.FreddyAutoHighBasketPark.armPosition targetArmPosition = org.firstinspires.ftc.teamcode.FreddyAutoHighBasketPark.armPosition.home;          //The target arm position

        private org.firstinspires.ftc.teamcode.FreddyAutoHighBasketPark.slidePosition currentSlidePosition = org.firstinspires.ftc.teamcode.FreddyAutoHighBasketPark.slidePosition.home;            // The current slide position

        private org.firstinspires.ftc.teamcode.FreddyAutoHighBasketPark.slidePosition targetSlidePosition = org.firstinspires.ftc.teamcode.FreddyAutoHighBasketPark.slidePosition.home;             // The target slide position

        private org.firstinspires.ftc.teamcode.FreddyAutoHighBasketPark.driveMode currentDriveMode = org.firstinspires.ftc.teamcode.FreddyAutoHighBasketPark.driveMode.normal;              //The current drive mode
        ...
        private static final FreddyAutoHighBasketPark.robot currentRobot = FreddyAutoHighBasketPark.robot.Freddy;                   // The robot
        ...
        public void runOpMode() {
            ...
            gyroStrafe(STRAFE_SPEED, 26.0, 0.0, org.firstinspires.ftc.teamcode.FreddyAutoHighBasketPark.strafeDirection.left);
            ...
            gyroStrafe(STRAFE_SPEED, 7.0, -45.0, org.firstinspires.ftc.teamcode.FreddyAutoHighBasketPark.strafeDirection.left);
        ...
        private void MoveArmToHomePosition() {
            while (opModeIsActive() && this.currentArmPosition != org.firstinspires.ftc.teamcode.FreddyAutoHighBasketPark.armPosition.home) {
                ...
                switch (this.currentArmPosition) {
                    case collectUp:
                        ...
                        if (this.isMotorAtPosition(slideArmMotor) || this.isArmFrontButtonPressed) {
                            ...
                            //Success
                            this.currentArmPosition = org.firstinspires.ftc.teamcode.FreddyAutoHighBasketPark.armPosition.home;
                        }
        ...
        private void MoveArmToDeliveryUpPosition() {
            ...
            while (opModeIsActive() && this.currentArmPosition != org.firstinspires.ftc.teamcode.FreddyAutoHighBasketPark.armPosition.deliveryUp) {
                this.HandleArmSensors();
                ...
                switch (this.currentArmPosition) {
                    ...
                    case collectUp: {
                        ...
                        if (this.isMotorAtPosition(slideArmMotor) || this.isArmBackButtonPressed) {
                            ...
                            //Success
                            this.currentArmPosition = org.firstinspires.ftc.teamcode.FreddyAutoHighBasketPark.armPosition.deliveryUp;
                        }
                    }
                    break;
        ...
        private void MoveSlideToHighBasketPosition() {
            ...
            while (opModeIsActive() && currentSlidePosition != org.firstinspires.ftc.teamcode.FreddyAutoHighBasketPark.slidePosition.highBasket) {
                this.HandleArmSensors();
                ...
                if (this.isMotorAtPosition(slideMotor) ||
                    ...
                    this.currentSlidePosition = org.firstinspires.ftc.teamcode.FreddyAutoHighBasketPark.slidePosition.highBasket;
                }
            }
        }

        private void MoveSlideToHomePosition() {
            while (opModeIsActive() && currentSlidePosition != org.firstinspires.ftc.teamcode.FreddyAutoHighBasketPark.slidePosition.home) {
                this.HandleArmSensors();
                ...
                if (this.isMotorAtPosition(slideMotor)) {
                    this.currentSlidePosition = org.firstinspires.ftc.teamcode.FreddyAutoHighBasketPark.slidePosition.home;
                }
            }
        }
        ...
        private void ConfigureHardwareValues(){
            if (currentRobot == FreddyAutoHighBasketPark.robot.Freddy) {
            ...
            else if (currentRobot == FreddyAutoHighBasketPark.robot.Napoleon){
                SLIDE_HIGH_BASKET = 3450;
                SLIDE_HIGH_BASKET_MIN = 3300;
        ...
        public void gyroDrive(double speed, double distance, double angle) {
            ...
            while (opModeIsActive() && !isDriveComplete(targetTicks)) {
                ...
                double[] powers = calculateWheelPowers(speed * direction, 0.0, correction, org.firstinspires.ftc.teamcode.FreddyAutoHighBasketPark.strafeDirection.none);
        ...
        public void gyroStrafe(double speed, double distance, double angle, org.firstinspires.ftc.teamcode.FreddyAutoHighBasketPark.strafeDirection direction) {
        ...
        public void gyroTurn(double speed, double targetAngle) {
            ...
            do {
                ...
                double[] powers = calculateWheelPowers(0.0, 0.0, turnPower, org.firstinspires.ftc.teamcode.FreddyAutoHighBasketPark.strafeDirection.none);
                setMotorPowers(powers);
        ...
        private double[] calculateWheelPowers(double drive, double strafe, double turn, org.firstinspires.ftc.teamcode.FreddyAutoHighBasketPark.strafeDirection strafeDirection) {
            double[] wheelPowers = new double[4];

            //Strafe Left
            if (strafeDirection == org.firstinspires.ftc.teamcode.FreddyAutoHighBasketPark.strafeDirection.left){
